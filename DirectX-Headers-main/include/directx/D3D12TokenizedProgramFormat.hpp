...
// ENCODER MACRO: Init complete VerTok
...
// ENCODER MACRO: Init complete LenTok
...
// ENCODER MACRO: Init the opcode-type portion of OpcodeToken0
...
// DECODER MACRO: Read the resource return type for component (0-3) from
...
// ENCODER MACRO: Init complete CustomDataDescTok
...
// DECODER MACRO: Read the name from NameToken
...
// DECODER MACRO: Read global flags
...
// identifier. Read is a DWORD that gives the expected function table
